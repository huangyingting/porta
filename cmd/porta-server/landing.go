...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;min-height:100vh;color:var(--ink);background:#f5f6fa;overflow-x:hidden}
    ...
    .lead{max-width:550px;margin:0;color:var(--muted);font-size:clamp(15px,1.5vw,18px);line-height:1.58;letter-spacing:-.012em}.principles{display:flex;gap:20px;margin-top:28px;color:#4f5462;font-size:11px;font-weight:650}.principles span{display:flex;align-items:center;gap:8px}.principles span:before{content:"";width:4px;height:4px;border-radius:50%;background:var(--violet)}.access-link{display:inline-flex;align-items:center;gap:9px;margin-top:30px;border-radius:11px;background:#171923;color:white;padding:12px 17px;text-decoration:none;font-size:11px;font-weight:750;box-shadow:0 10px 24px rgba(23,25,35,.17)}.access-link:after{content:"→";font-size:14px}
    ...
    @media(max-width:520px){.page{width:min(100% - 24px,1120px)}header{height:60px}.availability span{display:none}main{padding:30px 0;gap:28px}h1{font-size:clamp(44px,13vw,58px)}.principles{flex-wrap:wrap;margin-top:22px}.access-link{margin-top:25px}.canvas{min-height:320px;border-radius:22px}.halo{width:185px;height:185px}.ring.one{width:230px;height:230px}.ring.two{width:275px;height:275px}.note{left:13px;right:13px;bottom:13px}.number{display:none}}
  </style>
</head>
<body>
  <div class="page">
