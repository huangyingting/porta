...
func downloadsPageHTML(clientName, host, version string, artifacts []downloadArtifact) string {
	...
	@font-face{font-family:"Mona Sans";src:url("/assets/mona-sans.woff2") format("woff2-variations");font-weight:200 900;font-display:swap}:root{font-family:"Mona Sans",sans-serif;color:#171923;background:#f5f6fa;--violet:#6558ed;--line:#e2e4ea}*{box-sizing:border-box}body{margin:0;min-height:100vh;background:radial-gradient(circle at 85% 0,rgba(115,217,208,.3),transparent 25rem),#f5f6fa}.page{width:min(900px,calc(100% - 28px));margin:auto;padding:24px 0 44px}.top{display:flex;justify-content:space-between;align-items:center}.brand{display:flex;align-items:center;gap:9px;font-weight:800}.brand img{width:29px}.logout{border:1px solid var(--line);border-radius:8px;background:rgba(255,255,255,.8);padding:7px 10px;font-size:10px;cursor:pointer}.hero{display:grid;grid-template-columns:1fr auto;gap:24px;align-items:end;margin:42px 0 22px}.eyebrow{color:var(--violet);font-size:9px;font-weight:800;letter-spacing:.14em;text-transform:uppercase}.version{display:inline-flex;margin-left:7px;padding:3px 7px;border-radius:999px;background:#ece9ff;color:#594ed6;letter-spacing:0;text-transform:none}h1{margin:8px 0 8px;font-size:clamp(36px,6vw,52px);line-height:.98;letter-spacing:-.055em}.lead{max-width:560px;margin:0;color:#747987;font-size:12px;line-height:1.55}.endpoint{min-width:240px;padding:11px 13px;border:1px solid rgba(255,255,255,.95);border-radius:11px;background:rgba(255,255,255,.78)}.endpoint small{display:block;margin-bottom:4px;color:#969aa5;font-size:8px;font-weight:750;letter-spacing:.09em;text-transform:uppercase}.endpoint code{font-size:10px}.files{display:grid;gap:7px}.download-row{display:grid;grid-template-columns:36px minmax(0,1fr) auto 112px;gap:12px;align-items:center;padding:11px 12px;border:1px solid rgba(255,255,255,.96);border-radius:13px;background:rgba(255,255,255,.88);box-shadow:0 5px 18px rgba(35,40,68,.035)}.platform-icon{display:grid;place-items:center;width:36px;height:36px;border-radius:10px;background:linear-gradient(145deg,#ece9ff,#e5f8f5);color:#584bd7;font-size:11px;font-weight:850}.platform-line{display:flex;align-items:center;gap:7px}.platform-line h2{margin:0;font-size:13px;letter-spacing:-.02em}.package p{margin:3px 0 0;color:#858995;font-size:9px}.recommended{padding:2px 5px;border-radius:5px;background:#e6f7f2;color:#218568;font-size:7px;font-weight:800}.meta{display:flex;gap:5px}.meta span{padding:4px 6px;border-radius:6px;background:#f1f2f6;color:#727783;font-size:8px;white-space:nowrap}.download-button{display:flex;align-items:center;justify-content:space-between;border-radius:8px;background:#171923;color:white;padding:8px 9px;text-decoration:none;font-size:9px;font-weight:750}.download-button span{font-size:12px}.support{display:flex;justify-content:space-between;gap:18px;margin-top:14px;padding-top:14px;border-top:1px solid rgba(25,29,45,.1);color:#858995;font-size:9px}.support a{color:#665cf6;text-decoration:none}.empty{padding:34px;border:1px dashed #ccd0da;border-radius:13px;text-align:center}.empty strong,.empty span{display:block}.empty span{margin-top:5px;color:#888d99}@media(max-width:680px){.hero{grid-template-columns:1fr;margin-top:34px}.endpoint{min-width:0}.download-row{grid-template-columns:36px minmax(0,1fr) 94px}.meta{display:none}}@media(max-width:430px){.download-row{grid-template-columns:32px minmax(0,1fr)}.platform-icon{width:32px;height:32px}.download-button{grid-column:1/-1}.support{align-items:flex-start;flex-direction:column}}</style></head><body><main class="page"><div class="top"><div class="brand"><img src="/assets/porta-mark.svg" alt="">Porta</div><form method="post" action="/portal/logout"><button class="logout">Sign out</button></form></div><section class="hero"><div><div class="eyebrow">Client version <span class="version">` + html.EscapeString(version) + `</span></div><h1>Downloads</h1><p class="lead">Welcome, ` + html.EscapeString(clientName) + `. Choose the package for your device and use your existing Porta token to connect.</p></div><div class="endpoint"><small>Server address</small><code>https://` + html.EscapeString(host) + `</code></div></section><section class="files">` + rows.String() + `</section><div class="support"><span>Verify package integrity before installation.</span><a href="/download/SHA256SUMS">SHA256 checksums</a></div></main></body></html>`
}
